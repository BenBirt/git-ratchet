...
// protocol, which git-ratchet's transparency-log mode speaks. The request
// carries an old tree size, a consistency proof and the signed checkpoint; it
// carries no Git objects.
